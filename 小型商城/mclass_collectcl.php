...
if(!$num){
	message('收藏失败','mclass.php?id='.$row_class);
	
	}else{
     message('收藏成功','mclass.php?id='.$row_class);
}
}else{
	echo "<script>alert('宝贝已经在收藏夹了啦！');parent.location.href='mclass.php?id=$row_class'; </script>";
}
?>