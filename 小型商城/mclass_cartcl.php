...
if(!$num){
	...
	message('添加失败','mclass.php?id='.$row_class);
	
	}else{
     message('添加成功','mclass.php?id='.$row_class);
		// header("Location: ./index.php");

}
}else{
       echo "<script>alert('宝贝已经在购物车等你啦！');parent.location.href='mclass.php?id=$row_class'; </script>";
}
?>