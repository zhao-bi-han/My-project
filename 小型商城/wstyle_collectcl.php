...
if(!$num){
	message('收藏失败','wstyle.php?id='.$row_style);
	
	}else{
     message('收藏成功','wstyle.php?id='.$row_style);
}
}else{
	echo "<script>alert('宝贝已经在收藏夹了啦！');parent.location.href='wstyle.php?id=$row_style'; </script>";
}
?>