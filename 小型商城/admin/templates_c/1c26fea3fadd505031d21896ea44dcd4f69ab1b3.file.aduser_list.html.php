<?php /* Smarty version Smarty-3.1.14, created on 2016-12-12 18:10:48
         compiled from "templates\aduser_list.html" */ ?>
<?php /*%%SmartyHeaderCode:1889558383620bdd6f3-21281594%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c26fea3fadd505031d21896ea44dcd4f69ab1b3' => 
    array (
      0 => 'templates\\aduser_list.html',
      1 => 1481537369,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1889558383620bdd6f3-21281594',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58383620d26692_06584813',
  'variables' => 
  array (
    'userlist' => 0,
    'adminuser' => 0,
...
<?php if ($_valid && !is_callable('content_58383620d26692_06584813')) {function content_58383620d26692_06584813($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8"/>
  <title>后台管理系统</title>
...
?>
    <tr> 
      ...
      <td>
        <a href="aduser_update.php?id=<?php echo $_smarty_tpl->tpl_vars['adminuser']->value['aduser_id'];?>
">修改</a>
        <a href="#" onclick="javascript:if(confirm('是否删除')) location='aduser_del.php?id=<?php echo $_smarty_tpl->tpl_vars['adminuser']->value['aduser_id'];?>
'">删除</a>
      </td>
    </tr>
    <?php }
...
?>
  ...
  <aside class="paging" style="margin: 7px 196px;">
   ...
   <a>…</a>
   <a href="aduser_list.php?page=<?php echo $_smarty_tpl->tpl_vars['maxpage']->value;?>
...
?>
   <a href="aduser_list.php?page=<?php echo $_smarty_tpl->tpl_vars['index']->value;?>
