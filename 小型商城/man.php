<?php
 require("include/include_top.php");
  ...
  $pagesize=32;
 $sql_count="select count(*)  as count from mz_goods where goods_sex=0";
 ...
 for($i=1;$i<=$maxpage;$i++)
 $maxarray[$i]=$i;
 $sql="select * from mz_goods where goods_sex=0 limit ".($page-1)*$pagesize.",$pagesize";
 $mgoods=my_query($sql);
//收藏夹商品
 ...
 $smarty->assign('mgoods',$mgoods);
  $smarty->display("templates/man.html");
?>