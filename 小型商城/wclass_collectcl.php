...
if(!$num){
	message('收藏失败','wclass.php?id='.$row_class);
	
	}else{
     message('收藏成功','wclass.php?id='.$row_class);
}
}else{
	echo "<script>alert('宝贝已经在收藏夹了啦！');parent.location.href='wclass.php?id=$row_class'; </script>";
}
?>