<?php /* Smarty version Smarty-3.1.14, created on 2017-06-01 12:46:37
...
" id="phone">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="password" name="pass" autocomplete="off" value="<?php echo $_smarty_tpl->tpl_vars['userlist']->value[0]['user_password'];?>
" class="layui-input" id="pass">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea class="area"><?php echo $_smarty_tpl->tpl_vars['userlist']->value[0]['user_intro'];?>
</textarea>
					</div>
				</div>
				<div class="layui-form-item">
