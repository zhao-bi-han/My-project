...
$pagesize=10;
$sql_count="select count(*)  as count from look_sth where look_way=1";
...
for($i=1;$i<=$maxpage;$i++)
 $maxarray[$i]=$i;
$sql="select * from look_sth where look_way=1 order by id desc limit ".($page-1)*$pagesize.",$pagesize";
$rec=my_query($sql);
...
$smarty->display("templates/claim_list.html");
?>