<?php /* Smarty version Smarty-3.1.14, created on 2017-04-26 08:52:36
    	...
    	if(value==''){
    		...
    		$.ajax({
    			...
    			success: function(text){
    				...
    				if(text==0){
    					layer.msg("没查到该管理员的信息");
    				}else{
    					$(".site-table tbody").empty();
    					var html='';
    					html+="<tr>";
    					html+="<td><input type='checkbox'></td>";
    					html+="<td>"+text[0]['user_num']+"</td>";
    					html+="<td>"+text[0]['user_name']+"</td>";
    					html+="<td>"+text[0]['user_phone']+"</td>";
    					html+="<td>"+text[0]['user_username']+"</td>";
    					html+="<td>"+text[0]['user_pass']+"</td>";
    					html+="<td>";
			...
			<form class="layui-form" action="">
				<div class="layui-form-item">
					<div class="layui-input-block search">
						<input type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入姓名或编号" class="layui-input">
...
?>
						<tr>
							...
							<td><?php echo $_smarty_tpl->tpl_vars['user']->value['user_num'];?>
</td>
							...
							<td><?php echo $_smarty_tpl->tpl_vars['user']->value['user_pass'];?>
</td>
							<td>
